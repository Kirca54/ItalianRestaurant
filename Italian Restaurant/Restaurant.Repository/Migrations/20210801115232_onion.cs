    ...
    public partial class onion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodInOrders", x => new { x.FoodId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_FoodInOrders_Orders_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodInOrders_Foods_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodInShoppingCarts", x => new { x.FoodId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_FoodInShoppingCarts_ShoppingCarts_FoodId",
                        column: x => x.FoodId,
                        principalTable: "ShoppingCarts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodInShoppingCarts_Foods_ShoppingCartId",
